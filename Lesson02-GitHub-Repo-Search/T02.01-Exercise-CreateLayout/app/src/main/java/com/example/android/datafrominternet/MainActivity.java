...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		mSearchBoxEditText = (EditText) findViewById(R.id.edit_query);
		...
		mSearchResultsTextView = (TextView) findViewById(R.id.tv_github_search_results_jsontv_github_search_results_json);
    }
}
