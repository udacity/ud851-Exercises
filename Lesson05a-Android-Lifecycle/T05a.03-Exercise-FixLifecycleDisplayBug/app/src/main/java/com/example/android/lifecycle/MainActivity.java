...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks CHECKED
      public static ArrayList<String> mLifeCycleCallbalks = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay CHECKED
         for(int i = mLifeCycleCallbalks.size()-1; i>=0; i--)
         {
             mLifecycleDisplay.append(mLifeCycleCallbalks.get(i).toString()+"/n");
         }

        // TODO (5) Clear mLifecycleCallbacks after iterating through it CHECKED
        mLifeCycleCallbalks.clear();
    ...
    protected void onStop() {
        ...
        // TODO (2) Add the ON_STOP String to the front of mLifecycleCallbacks CHECKED
        mLifeCycleCallbalks.add(ON_STOP);
    ...
    protected void onDestroy() {
        ...
        // TODO (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks CHECKED
        mLifeCycleCallbalks.add(ON_DESTROY);
