...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        for (String callback : mLifecycleCallbacks) {
            mLifecycleDisplay.append(callback + "\n");
        }

        // COMPLETED Clear mLifecycleCallbacks after iterating through it
    ...
    protected void onStop() {
        ...
        // COMPLETED Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        ...
        // COMPLETED Add the ON_DESTROY String to the front of mLifecycleCallbacks
