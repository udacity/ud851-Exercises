...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if(savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
           mLifecycleDisplay.setText((CharSequence) savedInstanceState.get(LIFECYCLE_CALLBACKS_TEXT_KEY));
       }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        logAndAppend(LIFECYCLE_CALLBACKS_TEXT_KEY);
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY,mLifecycleDisplay.getText().toString().trim());
    }
