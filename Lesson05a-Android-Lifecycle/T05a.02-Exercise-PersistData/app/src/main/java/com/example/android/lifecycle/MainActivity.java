...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
        if (savedInstanceState != null) {
            String savedCallback = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            if (savedCallback != null) {
                mLifecycleDisplay.setText(savedCallback);
            }
        }
    ...
    // COMPLETED Override onSaveInstanceState
    @Override
    protected void onSaveInstanceState(Bundle outState) {
        // Do steps 3 - 5 within onSaveInstanceState
        // COMPLETED Call super.onSaveInstanceState
        super.onSaveInstanceState(outState);
        // COMPLETED Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
        logAndAppend(ON_SAVE_INSTANCE_STATE);
        // COMPLETED Put the text from the TextView in the outState bundle
