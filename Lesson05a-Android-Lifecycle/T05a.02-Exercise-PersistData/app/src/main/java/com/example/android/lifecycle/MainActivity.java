...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
                String previousLifecycles = savedInstanceState
                        .getString(LIFECYCLE_CALLBACKS_TEXT_KEY);

                mLifecycleDisplay.setText(previousLifecycles);
            }
        }
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        String currentLifecycle = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, currentLifecycle);
    }
