...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED Create and instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter
        // COMPLETED Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED
    ...
    // COMPLETED Override onResume and setup your broadcast receiver. Do this by calling
    ...
    // COMPLETED Override onPause and unregister your receiver using the unregisterReceiver method
    @Override
    ...
    // COMPLETED Create a new method called showCharging which takes a boolean. This method should
    ...
    // COMPLETED Create an inner class called ChargingBroadcastReceiver that extends BroadcastReceiver
    private class ChargingBroadCastReceiver extends BroadcastReceiver {
        // COMPLETED Override onReceive to get the action from the intent and see if it matches the
        // Intent.ACTION_POWER_CONNECTED. If it matches, it's charging. If it doesn't match, it's not
        // charging.
        // COMPLETED Update the UI using the showCharging method you wrote
        @Override
        public void onReceive(Context context, Intent intent) {
            showCharging(Intent.ACTION_POWER_CONNECTED.equals(intent.getAction()));
        }
    }
}