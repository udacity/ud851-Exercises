...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO DONE (5) Create and instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter
        // TODO DONE (6) Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED
    ...
    // TODO DONE (7) Override onResume and setup your broadcast receiver. Do this by calling
    ...
    // TODO DONE (8) Override onPause and unregister your receiver using the unregisterReceiver method
    ...
    // TODO DONE (1) Create a new method called showCharging which takes a boolean. This method should
    ...
    // TODO DONE (2) Create an inner class called ChargingBroadcastReceiver that extends BroadcastReceiver
        // TODO DONE (3) Override onReceive to get the action from the intent and see if it matches the
        // Intent.ACTION_POWER_CONNECTED. If it matches, it's charging. If it doesn't match, it's not
        // charging.
        // TODO DONE (4) Update the UI using the showCharging method you wrote
    private class ChargingBroadcastReceiver extends BroadcastReceiver {

        @RequiresApi(api = Build.VERSION_CODES.KITKAT)
        @Override
        public void onReceive(Context context, Intent intent) {
            boolean isCharging = Objects.equals(intent.getAction(), Intent.ACTION_POWER_CONNECTED);
