...
public final class NotificationUtils {
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pendinInt = PendingIntent.getService(context, WATER_REMINDER_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (9) Create an Action for the user to ignore the notification (and dismiss it)
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px, "Ignore", pendinInt);
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, WATER_REMINDER_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px, "Add drink", pendingIntent);;
