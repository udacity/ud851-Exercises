...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERVAL_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(REMINDER_INTERVAL_SECONDS));
    ...
    synchronized public static void scheduleChargingReminder(final Context context){
        ...
        irebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(driver);
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(
                        ...
                        REMINDER_INTERVAL_SECONDS + SYNC_FLEXTIME_SECONDS)).setReplaceCurrent(true)
                .build();
