...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARGING_REMINDER_NOTIFICATION = "charging-reminder-notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_CHARGING_REMINDER_NOTIFICATION.equals(action)) {
    ...
    // COMPLETED Create an additional task for issuing a charging reminder notification.
