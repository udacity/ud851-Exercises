...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        mToast.show();
        // COMPLETED Create an explicit intent for WaterReminderIntentService
        Intent intent = new Intent(this, WaterReminderIntentService.class);
        // COMPLETED Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        intent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        // COMPLETED Call startService and pass the explicit intent you just created
        startService(intent);
    }
