...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // COMPLETED Create a new Empty Activity named SettingsActivity; make sure to generate the
    // activity_settings.xml layout file as well and add the activity to the manifest

    // COMPLETED Add the menu to the menu bar
    // COMPLETED When the "Settings" menu item is pressed, open SettingsActivity
