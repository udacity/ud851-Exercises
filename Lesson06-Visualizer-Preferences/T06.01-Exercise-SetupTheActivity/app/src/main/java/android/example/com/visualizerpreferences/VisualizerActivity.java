...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TODO (1) Create a new Empty Activity named SettingsActivity; make sure to generate the CHECKED
    // activity_settings.xml layout file as well and add the activity to the manifest

    // TODO (2) Add a new resource folder called menu and create visualizer_menu.xml CHECKED
    // TODO (3) In visualizer_menu.xml create a menu item with a single item. The id should be CHECKED
    ...
    // TODO (5) Add the menu to the menu bar CHECKED
    // TODO (6) When the "Settings" menu item is pressed, open SettingsActivity CHECKED
    ...
    //this is the right way to start another intent from current parent activity
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        int itemRes = item.getItemId();
        switch(itemRes)
        {
            case R.id.action_setting:
                Toast.makeText(getApplicationContext(),"item "+itemRes,Toast.LENGTH_LONG).show();

                Intent SettingActivity = new Intent();
                Context ourContext = VisualizerActivity.this;
