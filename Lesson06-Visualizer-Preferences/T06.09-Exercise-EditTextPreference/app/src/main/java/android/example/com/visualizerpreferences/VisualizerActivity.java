...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // COMPLETED Modify the setupSharedPreferences method and onSharedPreferencesChanged method to
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setMinSizeScale(getMinScale(sharedPreferences, getString(R.string.pref_min_scale_key)));
        loadColorFromPreferences(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    private Float getMinScale (SharedPreferences sharedPreferences, String key) {
        return Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_min_scale_key), "1"));
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        } else if (key.equals(getString(R.string.pref_min_scale_key))) {
            mVisualizerView.setMinSizeScale(getMinScale(sharedPreferences, getString(R.string.pref_min_scale_key)));
        }
    }
