...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        // TODO (4) Use resources here instead of the hard coded string and boolean checked
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.pref_showBass_key), getResources().getBoolean(R.bool.pref_default_value)));
