...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        // COMPLETED Use resources here instead of the hard coded string and boolean
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.show_bass_pref_key),
                getResources().getBoolean(R.bool.show_bass_true_value)));
