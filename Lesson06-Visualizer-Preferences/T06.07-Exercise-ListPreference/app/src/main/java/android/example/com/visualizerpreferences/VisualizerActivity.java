...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void setColorFromPreferences(SharedPreferences preferences)
    {
        mVisualizerView.setColor(preferences.getString(getString(R.string.pref_default_color_key),getString(R.string.pref_color_red_value)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        }else if(key.equals(getString(R.string.pref_default_color_key)))
        {
            setColorFromPreferences(sharedPreferences);
        }
    }
