...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // COMPLETED Update setupSharedPreferences and onSharedPreferenceChanged to load the color
    ...
    private void setColorFromSharedPreferences(SharedPreferences preferences) {
