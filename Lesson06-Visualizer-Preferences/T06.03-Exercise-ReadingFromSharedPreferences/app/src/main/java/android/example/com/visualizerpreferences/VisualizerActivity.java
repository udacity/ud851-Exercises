...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // COMPLETED Change the name of default setup to setupSharedPreferences
    private void setupSharedPreferences() {
        // COMPLETED Get a reference to the default shared preferences from the PreferenceManager class
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);

        // COMPLETED Get the value of the show_bass checkbox preference and use it to call setShowBass
