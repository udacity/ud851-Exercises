...
public class MainActivity extends AppCompatActivity {
	...
	TextView mToysListTextView;// = new TextView(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		String[] mToyNames = ToyBox.getToyNames();
        // TODO (5) Loop through each toy and append the name to the TextView (add \n for spacing)
		for ( int i = 0; i < mToyNames.length; i++){
		
			CharSequence names = mToysListTextView.getText();
			
			mToysListTextView.setText(names + "\n" + mToyNames[i]);
