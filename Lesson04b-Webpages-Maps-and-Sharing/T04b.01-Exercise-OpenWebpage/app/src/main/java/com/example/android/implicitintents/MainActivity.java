...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String strUrl = "https://www.udacity.com";
    ...
    // COMPLETED Create a method called openWebPage that accepts a String as a parameter
    // Do steps 2 - 4 within openWebPage
    public void openWebPage (String strUrl) {
        // COMPLETED Use Uri.parse to parse the String into a Uri
        Uri uri = Uri.parse(strUrl);

        // COMPLETED Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
        Intent openBrowserIntent = new Intent(Intent.ACTION_VIEW, uri);
        // COMPLETED Verify that this Intent can be launched and then call startActivity
