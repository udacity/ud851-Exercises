...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // COMPLETED Specify a String you'd like to share
        String textToShare = "Sharing this text";

        // COMPLETED Replace the Toast with shareText, passing in the String from step 5
    ...
    // COMPLETED Create a void method called shareText that accepts a String as a parameter
    // Do steps 2 - 4 within the shareText method
    private void shareText(String textToShare) {
        // COMPLETED Create a String variable called mimeType and set it to "text/plain"
        String mimeType = "text/plain";

        // COMPLETED Create a title for the chooser window that will pop up
        String title = "Share text display!";

        // COMPLETED Use ShareCompat.IntentBuilder to build the Intent and start the chooser
        ShareCompat.IntentBuilder.from(this).setChooserTitle(title)
                .setType(mimeType).setText(textToShare).startChooser();
    }
}