...
public class TaskContentProvider extends ContentProvider {
    ...
    public static final int URI_TASKS_MATCHER_ID = 100;

    public static final int URI_TASK_ID_MATCHER_ID = 101;
    ...
    private static UriMatcher buildMatcher() {
        ...
        uriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS, URI_TASKS_MATCHER_ID);
        uriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", URI_TASK_ID_MATCHER_ID);
