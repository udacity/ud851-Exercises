...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        String inputValue = ((EditText) findViewById(R.id.editTextTaskDescription)).getText().toString();
        ...
        contentValues.put(TaskContract.TaskEntry.COLUMN_DESCRIPTION, inputValue);
