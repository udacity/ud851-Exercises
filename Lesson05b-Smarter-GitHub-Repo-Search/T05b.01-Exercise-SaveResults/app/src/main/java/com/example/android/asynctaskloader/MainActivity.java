...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String URL_KEY_QUERY = "query";

    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String SEARCH_RAW_JSON = "result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String queryUrl = savedInstanceState.getString(URL_KEY_QUERY);
            String rawJSONResult = savedInstanceState.getString(SEARCH_RAW_JSON);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(URL_KEY_QUERY, queryUrl);
        ...
        String currentResult = mSearchResultsTextView.getText().toString();

        outState.putString(SEARCH_RAW_JSON, currentResult);
    }
