...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String JSON_DATA_RAW = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            String url = savedInstanceState.getString(QUERY_URL_KEY);
            mUrlDisplayTextView.setText(url);

            String json = savedInstanceState.getString(JSON_DATA_RAW);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(JSON_DATA_RAW, results);
