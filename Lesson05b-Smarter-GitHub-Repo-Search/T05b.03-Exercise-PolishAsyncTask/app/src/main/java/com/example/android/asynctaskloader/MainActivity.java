...
public class MainActivity extends AppCompatActivity implements
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            // TODO (1) Create a String member variable called mGithubJson that will store the raw JSON CHECKED
            String mGithubJson;
            ...
            protected void onStartLoading() {
                ...
                // TODO (2) If mGithubJson is not null, deliver that result. Otherwise, force a load CHECKED
                if(mGithubJson!=null && !TextUtils.isEmpty(mGithubJson))
                {
            ...
            // TODO (3) Override deliverResult and store the data in mGithubJson CHECKED
            // TODO (4) Call super.deliverResult after storing the data CHECKED
            @Override
