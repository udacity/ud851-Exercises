...
public class MainActivity extends AppCompatActivity {
 ...
 private ActivityMainBinding mBinding;
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat(getString(R.string.timeFormat), Locale.US);

        mBinding.textViewArrivalTime.setText(
                formatter.format(info.arrivalTime)
        );
        mBinding.textViewBoardingTime.setText(
                formatter.format(info.boardingTime));
        mBinding.textViewDepartureTime.setText(
                formatter.format(info.departureTime));
        ...
        mBinding.textViewBoardingInCountdown.setText(""+ TimeUnit.MINUTES.toMinutes(info.getMinutesUntilBoarding())+ " MIN");
    }
}
