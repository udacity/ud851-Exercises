    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // COMPLETED Retrieve the text from the EditText and store it in a variable
                ...
                // COMPLETED Use the putExtra method to put the String from the EditText in the Intent
