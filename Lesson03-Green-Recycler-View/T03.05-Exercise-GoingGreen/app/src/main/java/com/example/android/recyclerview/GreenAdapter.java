...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int viewHolderBackgroundColorFromInstance = ColorUtils.getViewHolderBackgroundColorFromInstance(context, viewHolderCount);

        // TODO (14) Set the background color of viewHolder.itemView with the color from above
        viewHolder.itemView.setBackgroundColor(viewHolderBackgroundColorFromInstance);
